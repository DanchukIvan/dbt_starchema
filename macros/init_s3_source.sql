{% macro init_s3_sources() -%}
    ...
    {% set sql %}
        ...
        CREATE TABLE IF NOT EXISTS {{ target.schema -}}.src_customer
        (
                C_CUSTKEY       UInt32,
                C_NAME          String,
                C_ADDRESS       String,
        ...
        CREATE TABLE IF NOT EXISTS {{ target.schema -}}.src_lineorder
        (
            LO_ORDERKEY             UInt32,
            LO_LINENUMBER           UInt8,
            LO_CUSTKEY              UInt32,
        ...
        CREATE TABLE IF NOT EXISTS {{ target.schema -}}.src_part
        (
                P_PARTKEY       UInt32,
                P_NAME          String,
        ...
        CREATE TABLE IF NOT EXISTS {{ target.schema -}}.src_supplier
        (
                S_SUPPKEY       UInt32,
                S_NAME          String,
                S_ADDRESS       String,
